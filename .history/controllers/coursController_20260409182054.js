...
// Récupérer un cours par son ID (public)
...
// Créer un nouveau cours (protégé - utilisateur connecté)
const createCours = async (req, res) => {
  try {
    ...
    // Gestion des erreurs de duplication (titre unique)
    if (error.code === 11000) {
      return res.status(400).json({
        success: false,
...
// Mettre à jour un cours (protégé - admin uniquement)
...
// Supprimer un cours (protégé - admin uniquement)
