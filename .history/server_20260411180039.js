...
// Augmenter le timeout (à ajouter au début du fichier)
...
const coursrroutes = require('./routes/coursroutes');

// Importer les middlewares d'authentification
const { verifierToken, verifierAdmin } = require('./middleware/auth');

// Importer les routes supplémentaires (commentées car fichiers manquants)
// const commentaireRoutes = require('./routes/commentaireRoutes');
// const categorieRoutes = require('./routes/categorieRoutes');
// const adminController = require('./controllers/adminController');

// Middleware upload (optionnel - commenté si fichier non disponible)
...
// Servir les fichiers statiques uploadés (si dossier existe)
...
// Routes commentaires et catégories (commentées - fichiers manquants)
// app.use('/api/commentaires', commentaireRoutes);
// app.use('/api/categories', categorieRoutes);

// Route upload (commentée car nécessite multer)
// Décommentez si vous avez installé multer et créé middleware/upload.js
/*
...
/// Routes admin statistiques (commentées - fichier manquant)
